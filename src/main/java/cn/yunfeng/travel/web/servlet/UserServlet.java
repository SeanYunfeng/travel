...
import cn.yunfeng.travel.domain.ResultInfo;
import cn.yunfeng.travel.domain.User;
import cn.yunfeng.travel.service.UserService;
import cn.yunfeng.travel.service.impl.UserServiceImpl;
...
public class UserServlet extends BaseServlet {
    ...
    public void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(loginUser==null){
            ...
            cookieName.setMaxAge(60*60*10);
            cookiePassword.setMaxAge(60*60*10);
            //该用户激活并且存在
            info.setFlag(true);
        }
        //将返回信息写回前台
